...
Introducción: Emir Chacra
Diseño de hardware utilizando [DaisyPod](https://electro-smith.com/products/pod), carcasa y otros elementos.
Creación de un pedal de efecto de sonido.

***

### Primeros pasos: código prearmado hecho por Emir
...
Al intentar analizar el código, puedo destacar que las primeras líneas son recursos otorgados por "Electrosmith": ["daisy_pod.h"](https://daisy.audio/libDaisy/daisy__pod_8h_source/) y [daisysp.h](https://daisy.audio/DaisySP/daisysp_8h_source/)
